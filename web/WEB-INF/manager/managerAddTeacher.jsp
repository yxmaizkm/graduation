...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <form class="layui-form" id="form1" action="${pageContext.request.contextPath}/manager/addAnn">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <input name="teacherNo" placeholder="请输入编号" class="layui-input"/>
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form','jquery','layer'],function () {
        ...
        form.on('submit(formDemo)',function (data) {
            $.ajax({
                url: "${pageContext.request.contextPath}/manager/teacher/add",
                data:data.field,
                type:"post",
                dataType: "text",
                success:function (data) {
                    layer.msg(data,{time:2000,icon:6},
                        function () {
                            //跳转到全部学生的显示界面
                            window.location.href = '${pageContext.request.contextPath}/manager/teachers'
                        });
                   // $("#form1")[0].reset();//表单重置
                    //form.render();
                },error:function (data) {
